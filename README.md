...
> 🔗 **링크·전화번호만 바꾸실 분은 [수정방법.md](수정방법.md) 를 보세요.**
> 이 문서는 개발자용입니다.
...
버튼에 들어갈 주소를 바꾸는 방법은 [수정방법.md](수정방법.md) 에 따로
정리했습니다 — 개발 경험이 없는 사람이 GitHub 웹 화면에서 직접 고칠 수 있게
쓴 문서입니다.

`index.html` 안에도 어디를 고쳐야 하는지 주석으로 적어 두었습니다.
