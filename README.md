...
| 버튼 | 넣을 주소 |
|---|---|
| 신입생 상담 신청하기 | 네이버폼 · 구글폼 주소 |
| 카카오톡으로 빠른 상담 | `http://pf.kakao.com/_○○○○○` |
| 비욘드 교육과정 살펴보기 | 블로그 글 주소 |
| 사송캠퍼스 수업 이야기 | 블로그 글 주소 |
| 학원 위치 · 주차 안내 | 네이버 지도 장소 주소 *(지금은 이름으로 검색되게 해 둠)* |
| 전화로 문의하기 | `tel:055-000-0000` |
| 인스타그램 · 네이버 블로그 | 각 계정 주소 |

맨 아래 **등록번호**(`제0000호`)도 실제 번호로 바꿔야 합니다 —
학원 광고에는 등록번호 표기가 법으로 요구됩니다.
